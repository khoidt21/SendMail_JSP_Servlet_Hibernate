 ...
 * @author vuvan
 */
@WebServlet (urlPatterns = "/SendEmailController")
public class SendEmailController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        MailMessage mm = new MailMessage(to, cc, subject, content);
        
        try {
            MyMail.getInstance().send(mm);
            
            try (PrintWriter out = response.getWriter()) {
                //Khi gui email thanh cong
                String success = "Send Email Successful!";
                request.setAttribute("done", success);
                request.getRequestDispatcher("sendEmail.jsp").forward(request, response);
            }
        } catch (MessagingException e) {
            mm.setError(e.getMessage());
